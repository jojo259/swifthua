...
/*
modifications:
-hardcoded different URL (jsdelivr --> the flask api) to remove dependency
*/
...
var HanziWriter = (function () {
  ...
  const getCharDataUrl = char => "/api/chardata/" + char; // literally hardcoded different URL bc cant figure out loadCharData 
